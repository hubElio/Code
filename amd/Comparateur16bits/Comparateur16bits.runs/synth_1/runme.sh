...
HD_PWD='C:/Users/Eliot/Comparateur16bits/Comparateur16bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StateMachineUART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StateMachineUART.tcl
