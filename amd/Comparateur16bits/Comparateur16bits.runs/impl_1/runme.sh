...
HD_PWD='C:/Users/Eliot/Comparateur16bits/Comparateur16bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StateMachineUART.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StateMachineUART.tcl -notrace
