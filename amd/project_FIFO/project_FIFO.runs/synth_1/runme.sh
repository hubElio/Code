...
HD_PWD='C:/Users/Eliot/project_FIFO/project_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_profondeur_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_profondeur_16.tcl
