...
HD_PWD='C:/Users/Eliot/project_FIFO/project_FIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_profondeur_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFO_profondeur_16.tcl -notrace
