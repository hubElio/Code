...
HD_PWD='C:/Users/Eliot/Documents/Code/amd/project_test/project_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Reg1bit.tcl -notrace
