...
HD_PWD='C:/Users/Eliot/Documents/Code/amd/project_test/project_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reg1bit.tcl
