...
HD_PWD='C:/Users/Eliot/project_registreDecalage/project_registreDecalage.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RegistreADecalage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RegistreADecalage.tcl -notrace
