...
HD_PWD='C:/Users/Eliot/project_registreDecalage/project_registreDecalage.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegistreADecalage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegistreADecalage.tcl
